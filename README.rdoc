...
1. Git repository
        ...
        git clone git@github.com:stringwire/web.git stringwire
...
6. To test 4 API Calls
        ...
        iv) Update a Snippet
          POST http://127.0.0.1:3000/api/v1/codes/:id/update Content-type: Application/json
          data => { code: { text: "bla blah", is_private: false} }
